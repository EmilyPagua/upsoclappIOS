//
//  PopularyTableViewController.swift
//  appupsocl
//
...
class PopularyTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellPopulary", for: indexPath) as! NewsViewCell
    ...
    */
    ...
    func callWebServices(_ paged: String ){
        ...
        let urlPath = ApiConstants.PropertyKey.baseURL + ApiConstants.PropertyKey.listPost + ApiConstants.PropertyKey.filterCategoryName + Category.PropertyKey.populary
