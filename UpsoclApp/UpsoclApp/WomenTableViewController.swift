...
class WomenTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellWomen", for: indexPath) as! NewsViewCell
        // Configure the cell...
        if (newsList.count != 0 ){
    ...
    */
    ...
    func callWebServices(_ page: String){
    
        self.indicator.startAnimating()
        
        let urlPath = ApiConstants.PropertyKey.baseURL + ApiConstants.PropertyKey.listPost + ApiConstants.PropertyKey.filterCategoryName + Category.PropertyKey.women
